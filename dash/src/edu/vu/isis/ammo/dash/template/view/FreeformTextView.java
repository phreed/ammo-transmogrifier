...
public class FreeformTextView implements GuiField {
	...
	public FreeformTextView(Context context, Element eNode) {
		...
		// parent.
		viewGroup = (ViewGroup)LayoutInflater.from(context).inflate(R.layout.template_freeform_text_view, null);
		TextView label = (TextView) viewGroup.findViewById(R.id.freeform_text_view_label);
		editText = (TextView) viewGroup.findViewById(R.id.freeform_text_view_field);
